...
class Mcustomer extends CI_Model {
	...
	public function __construct(){
        ...
        $this->table2 = $this->db->dbprefix('user');
    ...
    function customer_username(){
        $query = $this->db->get($this->table);
        return $query->result_array();
       
    }

    function customer_check_username_user($username){
        $this->db->where('username', $username);
    ...
    function customer_detail_email_user($email){
    ...
    public function customer_insert_customer($data){
            $this->db->insert($this->table, $data);
    }

    public function customer_insert_user($data){
