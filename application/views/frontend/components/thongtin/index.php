                    ...
                    <tbody style="border: 1px solid silver;">
                        ...
                        <tr style="border-bottom: 1px solid silver;">
                            ...
                            <td style="text-align: center; padding:5px 10px;"><span class="price-2">
                                    ...
                                    echo number_format($uData['count'] * $uData['price'])
                            ...
                            <td width="70">
                                <span> <a style="color: #0f9ed8;" href="account/orders/<?php echo $value['id'] ?>">Xem
                                        chi tiết</a></span>
                            </td>
                            <td width="70">
                ...
                <div class="table-order">
                    <table style="padding-right: 10px; width: 100%;">
                        ...
                        foreach ($order as $value):
                            ...
                            $code = $value['orderCode'];
                            $sqlProductByCustomer = "SELECT * FROM db_orderdetail WHERE orderCode='$code'";

                            $productByCustomer = $conn->query($sqlProductByCustomer);
                            $dataProductByCustomer = $productByCustomer->fetch_assoc();
                        ...
                        ?>
                            <tr style="border-bottom: 1px solid silver;">
                                ...
                                <td style="text-align: center; padding:5px 10px;"><span
                                        class="price-2"><?php echo number_format($dataProductByCustomer['count'] * $dataProductByCustomer['price']) ?>
                                        VNĐ</span></td>
                                <td style="padding:5px 10px; text-align: center;">
                                    <?php
                                   switch ($value['status']) {
