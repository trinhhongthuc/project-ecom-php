                ...
                <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" name='info-order'
                 ...
                 ?>
                    <div class="checkout-content">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-login-checkout"
                            ...
                            <div class="wrap-info"
                                ...
                                <table class="table tinfo">
                                    <tbody>
                                        ...
                                        <?php  endforeach;  ?>
                                        <?php 
                                            $result = array_unique($name_shop);
                                            foreach (  $result as $valueItem ) { ?>
                                        <tr>
                                            <td class="width30 text-right td-right-order">Shop name: <span
                                                    class="require_symbol">* </span></td>
                                            <td>
                                                <input type="text" class="form-control" placeholder="Họ và tên"
                                                    name="shop_name" value="<?php echo  $valueItem ?>" />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 products-detail">
                            ...
                            <table class="table" style="color: #333">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><?php $sp= $sp + $value; echo $value  ?></td>
                                        <td style="text-align:center">
                                            <?php
                                                ...
                                                if($arrayShop === []) {
                                                    $priceNumber = $row['price_shipProduct'];
                                                    array_push($arrayShop, $row['shop_name']);

                                                }else if($arrayShop !== []) {
                                                    foreach ($arrayShop as $key ) :
                                                        if( $key === $row['shop_name']) {
                                                            $priceNumber +=   $row['price_shipProduct'];
                                                            array_push($arrayShop, $row['shop_name']);
                                                        }
                                                    endforeach;
                                        ...
                                        <td style="text-align:center">
                                            <?php 
                                                 echo  number_format($row['price_shipProduct']).' VNĐ';
                                            ?>
                                        </td>
                                        <td style="float: right;">
                                            <?php 
                                                $total=0;
                                                $total=$total + ($price_end  * $value ) + $row['price_shipProduct'];
                                                $money+=$total;
                                                echo  number_format(($price_end  * $value ) + $row['price_shipProduct']).' VNĐ';
                                            ?>
                                        </td>
                                    ...
                                    <?php 
                                        ...
                                        if($this->session->userdata('coupon_price')){
                                            ...
                                            $price_vocher =$this->session->userdata('coupon_price');
                                            echo '
                                                <td colspan="4">Voucher giảm giá: </td>
                                                <td>
                                                <p style="float:right;"> -'.$price_coupon.' VNĐ</p> 
                                                <input type="text" style="display:none" name="price_vocher" value="'.$price_vocher.'" />
                                        ...
                                        <td class="text-center">
                                            <p style="font-size: 15px; color: red;">
                                                ...
                                                if(isset($price_coupon_money))
                                                    ...
                                                    echo number_format($money - $price_vocher).' VNĐ'; 
                                                ?>
                                            </p>
                                        </td>
                                    </tr>
