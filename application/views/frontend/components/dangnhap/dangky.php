                    ...
                    <div id="register">
                        ...
                        <div class="acc_content clearfix" style="display: block;">
                            <form accept-charset="UTF-8" action="" id="customer_register" method="post">
                                ...
                                <div class="col_full">
                                    <label for="first_name">Phân quyền:</label>
                                    <div name="" id="">
                                        <div style="width: 120px;display: flex;justify-content: space-between;">
                                            <label for="phanquyen1" style="font-weight: 400; color: #333;">
                                                Khách hàng:
                                            </label>
                                            <input type="radio" name="phanquyen" id="phanquyen1" value="khachhang">
                                        </div>
                                        <div style="width: 120px;display: flex;justify-content: space-between;">
                                            <label for="phanquyen2" style="font-weight: 400; color: #333;">
                                                Bán hàng:
                                            </label>
                                            <input type="radio" name="phanquyen" id="phanquyen2" value="ban hang">
                                        </div>
                                    </div>

                                    <div class="col_full">
                                        <label for="first_name">Tên Shop (viết liền):</label>
                                        <input type="text" id="first_name" name="shop_name" placeholder="Tên shop"
                                            class="form-control">
                                        <div class="error" id="name_error"><?php echo form_error('shop_name')?></div>
                                    </div>

                                    <div class="col_full nobottommargin">
                                        <button class="button button-3d button-black nomargin" id="register-form-submit"
                                            name="register-form-submit" type="submit" style="margin-bottom: 20px">Đăng
                                            ký</button>
                                        <ul>
                                            <li class="right" style="font-size: 18px;">Nếu đã có tài khoản, hãy <a
                                                    href="<?php echo base_url()?>dang-nhap"
                                                    style="font-size: 19px; color: #0f9ed8;">Đăng nhập</a></li>
                                        </ul>
                                    </div>
                            </form>
                        </div>
