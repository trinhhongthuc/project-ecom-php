    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            <a class="btn btn-primary btn-sm" href="admin/orders/recyclebin" role="button">
                <span class="glyphicon glyphicon-trash"></span> Đơn hàng đã lưu
                (<?php $total=$this->Morders->orders_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
                            ...
                            <div class="row" style='padding:0px; margin:0px;'>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <a class="btn btn-success btn-xs"
                                                        href="<?php echo base_url() ?>admin/orders/status/<?php echo $val['id'] ?>"
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger btn-xs"
                                        href="<?php echo base_url() ?>admin/orders/cancelorder/<?php echo $val['id'] ?>"
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-info btn-xs"
                                        href="<?php echo base_url() ?>admin/orders/detail/<?php echo $val['id'] ?>"
                                        role="button">
                                        <span class="glyphicon glyphicon-eye-open"></span> Xem
                                    </a>
                                    <!-- /Xóa -->
                                    <!-- <a class="btn bg-olive btn-xs"
                                        href="<?php echo base_url() ?>admin/orders/trash/<?php echo $val['id'] ?>"
                                ...
                                <?php foreach ($list as $val):
								$name = $this->Mcustomer->customer_detail($val['customerid']);
                                    if( $val['shop_name'] == $user['shop_name'] ) {
								?>
                                <tr>
                                    <td class="text-center"><?php echo $val['orderCode'] ?></td>
                                    <td><?php echo $val['fullname']; ?></td>
