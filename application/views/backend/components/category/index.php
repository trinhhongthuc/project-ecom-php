    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <a class="btn btn-primary btn-sm" href="admin/category/recyclebin" role="button">
                ...
                (<?php $total=$this->Mcategory->category_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
    <!-- Main content -->
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="<?php echo base_url() ?>admin/category/update/<?php echo $row['id'] ?>"><?php echo $row['name'] ?>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="<?php echo base_url() ?>admin/category/status/<?php echo $row['id'] ?>">
                                                    <?php if($row['status']==1):?>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-danger btn-xs"
                                                    href="<?php echo base_url() ?>admin/category/trash/<?php echo $row['id'] ?>"
