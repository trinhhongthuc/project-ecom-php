    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/producer/recyclebin" role="button">
                ...
                rác(<?php $total=$this->Mproducer->producer_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
    <!-- Main content -->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a
                                                        href="<?php echo base_url() ?>admin/producer/status/<?php echo $row['id'] ?>">
                                                        <?php if($row['status']==1):?>
                                                ...
                                                <?php
														if($user['role']==1){
															...
															<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/producer/update/'.$row['id'].'"
                                                role = "button">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-danger btn-xs"
                                                        href="<?php echo base_url() ?>admin/producer/trash/<?php echo $row['id'] ?>"
