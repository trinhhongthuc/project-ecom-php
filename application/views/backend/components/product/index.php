<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="breadcrumb">
            ...
            <?php
			$name = $this->Muser->user_manage($user['fullname']);
			if($name == "ban hang" || $name == "admin"){
            ...
            <a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/product/recyclebin" role="button">
                ...
                rác(<?php $total=$this->Mproduct->product_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
    <!-- Main content -->
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 16px;"><?php echo $row['shop_name'] ?></td>
                                                <td class="text-center">
                                                    <?php echo $row['number'] - $row['number_buy'] ?></td>
                                                <?php 
                                                                $namecat = $this->Mcategory->category_name($row['catid']);
                                                                ?>
                                                <td><?php echo $namecat ?></td>
                                                <td class="text-center">
                                                    <a href="admin/product/status/<?php echo $row['id'] ?>">
                                                        <?php if($row['status']==1):?>
                                                ...
                                                <?php
                                                                if($user['role']==1){
                                                                    ...
                                                                    <a class="btn btn-success btn-xs" href="admin/product/update/'.$row['id'].'"
                                                role = "button">
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-danger btn-xs"
                                                        href="admin/product/trash/<?php echo $row['id'] ?>"
                                            ...
                                            $name_shop = $user['shop_name'];
                                            $name_now = $row['shop_name'];
                                            if($name_now == $name_shop) {?>
                                            <tr>
                                                <td class="text-center"><?php echo $row['id'] ?></td>
                                                <td style="width:70px">
                                                    <img src="public/images/products/<?php echo $row['avatar'] ?>"
