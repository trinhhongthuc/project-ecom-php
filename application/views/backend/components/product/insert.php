                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="price_shipProduct" class="form-control" type="number" value="0" min="0"
                                        step="1" max="1000000000" placeholder="Price Ship" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="shop" class="form-control" type="text"
                                        value="<?php echo $user['shop_name'] ?>">
                                </div>
                            </div>
                        </div>
                    </div><!-- /.box -->
