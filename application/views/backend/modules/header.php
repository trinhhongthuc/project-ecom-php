<header class="main-header">
    <a href="<?php echo base_url()?>admin" class="logo" style="background: rgb(1, 127, 255)">
        <span class="logo-lg">Quản trị hệ thống</span>
    </a>
    <nav class="navbar navbar-static-top" style="height: 52px;background: rgb(1, 127, 255)">
                ...
                <li class="dropdown user user-menu" style="height: 52px; padding: 0px">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo base_url()?>admin/useradmin/update/<?php echo $user['id'] ?>"
